...
export default async function Home() {
  ...
  const recipes = allRecipes.slice(0, 12)
        ...
        <div className="container">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Discover our collection of easy air fryer recipes that are healthy, quick, and absolutely delicious. 
              From air fryer salmon recipes to crispy chicken wings, we have the best air fryer recipes for every meal.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-6 rounded-xl border border-orange-200">
              <h3 className="text-xl font-bold mb-2 text-orange-800">Air Fryer Chicken Recipes</h3>
              <p className="text-orange-700 text-sm">Perfect chicken breast and wings recipes</p>
              <div className="mt-3 text-xs text-orange-600">
                ✓ Air Fryer Chicken Breast Recipe<br/>
                ✓ Air Fryer Chicken Wings Recipe
              </div>
            </div>
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-xl border border-blue-200">
              <h3 className="text-xl font-bold mb-2 text-blue-800">Air Fryer Salmon Recipes</h3>
              <p className="text-blue-700 text-sm">Healthy and delicious salmon dishes</p>
              <div className="mt-3 text-xs text-blue-600">
                ✓ Salmon Air Fryer Recipe<br/>
                ✓ Air Fryer Salmon Recipe
              </div>
            </div>
            <div className="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-xl border border-green-200">
              <h3 className="text-xl font-bold mb-2 text-green-800">Easy Air Fryer Recipes</h3>
              <p className="text-green-700 text-sm">Simple recipes for beginners</p>
              <div className="mt-3 text-xs text-green-600">
                ✓ Air Fryer Bacon Recipe<br/>
                ✓ Air Fryer Broccoli Recipe
              </div>
            </div>
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-xl border border-purple-200">
              <h3 className="text-xl font-bold mb-2 text-purple-800">Healthy Air Fryer Recipes</h3>
              <p className="text-purple-700 text-sm">Nutritious meals with less oil</p>
              <div className="mt-3 text-xs text-purple-600">
                ✓ Air Fryer Cauliflower Recipes<br/>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="group bg-white p-8 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
              ...
              <h3 className="text-2xl font-display font-bold mb-3 text-gray-900">Healthier Meals</h3>
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
              ...
              <h3 className="text-2xl font-display font-bold mb-3 text-gray-900">Super Fast</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
              ...
              <h3 className="text-2xl font-display font-bold mb-3 text-gray-900">Easy to Master</h3>
              <p className="text-gray-600 leading-relaxed">
