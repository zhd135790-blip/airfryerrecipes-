    ...
    <section className="py-12">
      <div className="container max-w-3xl">
        ...
        <p className="text-gray-600 mb-8">
          Have questions or suggestions? We'd love to hear from you. Send us an email and we'll get back within 2-3 business days.
        </p>
        <div className="bg-white rounded-xl shadow border border-gray-200 p-6 space-y-4">
          <div>
            ...
            <div className="text-lg font-semibold">info@bestair-fryerrecipes.com</div>
          </div>
          <div>
            <div className="text-sm text-gray-500">Privacy requests</div>
            <div className="text-lg font-semibold">privacy@bestair-fryerrecipes.com</div>
          </div>
          <div className="pt-2">
